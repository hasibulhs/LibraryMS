...
{
    public partial class View_Admin_UserControl : UserControl
    {
        DBAccess con = new DBAccess();

        private static View_Admin_UserControl obj1;

        public static View_Admin_UserControl obj2
        {
            get
            {
                if (obj1 == null)
                {
                    obj1 = new View_Admin_UserControl();
                }
        ...
        public View_Admin_UserControl()
        {
            InitializeComponent();
        }

        private void View_Admin_UserControl_Load(object sender, EventArgs e)
        {
